...
import { FiSend, FiUser, FiMessageSquare, FiCpu } from 'react-icons/fi';
import Navbar from '../components/Navbar';

const AiChatbot = () => {
  const [messages, setMessages] = useState([
    { id: 1, text: "Hello! I'm your financial assistant. How can I help you today?", sender: 'ai', timestamp: new Date() }
  ]);
  ...
  const handleSendMessage = async (e) => {
    ...
    setTimeout(() => {
      const aiResponses = [
        "I can help you analyze your financial data. Would you like to upload a CSV file?",
        "Based on your recent transactions, you might want to consider reducing discretionary spending.",
        "Your investment portfolio is showing a positive trend this month.",
        "I notice you have several recurring subscriptions. Would you like me to analyze them for potential savings?",
        "Have you considered setting up an emergency fund? I can help you plan for that."
      ];
      ...
      <div className="pt-24 px-4 md:px-6 lg:px-8 pb-20">
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#E0E0E0] flex flex-col h-[70vh]">
            {/* Chat Header */}
            <div className="p-4 border-b border-[#E0E0E0] bg-gradient-to-r from-[#F8F9FA] to-[#E9ECEF]">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="p-3 bg-[#F8F9FA] rounded-lg border border-[#DEE2E6] hover:border-[#007BFF] transition-colors cursor-pointer">
